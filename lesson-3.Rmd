...
For a bipartite ecological network represented by an adjacency matrix with size HxV, where H is the number of hosts and V is the number of visitors, the number of species in the network is equal to H + V.
